...
public class Main6Activity extends AppCompatActivity implements View.OnClickListener {
    static int moves = 4 ;
    static int goal = 23;
    static int count6 =10;
    static int  result = 171;
    ...
    public void setClick(View view)
    {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.bclick);
        mp.start();
        Intent i=new Intent(Main6Activity.this,SettingActivity.class);
        TextView Level=(TextView)findViewById(R.id.level);
        i.putExtra("level6", count6);
        i.putExtra("calling-activity", MainActivity.ActivityConstants.ACTIVITY_6);
