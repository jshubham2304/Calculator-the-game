...
public class Main3Activity extends AppCompatActivity implements  View.OnClickListener {
    ...
    public void setClick(View view)
    {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.bclick);
        mp.start();
        Intent i=new Intent(Main3Activity.this,SettingActivity.class);
        TextView Level=(TextView)findViewById(R.id.level);
        i.putExtra("level3", count3);
        i.putExtra("calling-activity", MainActivity.ActivityConstants.ACTIVITY_3);
