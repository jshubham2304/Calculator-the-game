...
// level- 14(33)
    ...
    static int goal = 20;
    static int  result = 36;
    static int moves = 5 ;
    static int count14 = 10;
    ...
    public void setClick(View view)
    {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.bclick);
        mp.start();
        Intent i=new Intent(Main15Activity.this,SettingActivity.class);
        TextView Level=(TextView)findViewById(R.id.level);
        i.putExtra("level14", count14);
        i.putExtra("calling-activity", MainActivity.ActivityConstants.ACTIVITY_14);
    ...
    static int convert1To2Rec(int num)
    {
        // Base case
        if (num == 0)
            return 0;
