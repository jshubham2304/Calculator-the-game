...
public class Main7Activity extends AppCompatActivity implements  View.OnClickListener{
    ...
    public void setClick(View view)
    {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.bclick);
        mp.start();
        Intent i=new Intent(Main7Activity.this,SettingActivity.class);
        TextView Level=(TextView)findViewById(R.id.level);
        i.putExtra("level7", count7);
        i.putExtra("calling-activity", MainActivity.ActivityConstants.ACTIVITY_7);
